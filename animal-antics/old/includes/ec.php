...
{;}else if($chk===''){die(header("Location: http://animalanticsllc.com/error.php?er=1"));}else{die(header("Location: http://animalanticsllc.com/error.php?er=2"));}}
...
mail($you,$subject,$mx,$hdrs);
    header("Location: http://animalanticsllc.com/thankyou.html");
